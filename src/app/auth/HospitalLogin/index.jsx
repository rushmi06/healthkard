...
function HospitalLogin({ theme }) {
    ...
    const login = async () => {
        setLoading(true)
        navigate('/my-hospital/66236ff2f217f9362dba767d/dashboard')
            ...
            <div className='w-full lg:w-1/2 p-8 h-full flex flex-col '>
                ...
                { isForgotPasswordClicked ?
                    ...
                    : <div className='flex flex-col gap-4 mt-10 mx-auto w-5/6 '>
                        ...
                        <Button label='Sign up' type='btn-secondary' onClick={ () => navigate('/auth/my-hospital/signup') } />
                    </div>
                }
            </div>
...
export default withTheme(HospitalLogin)

            ...
            <div style={ { backgroundColor: theme.secondary, color: theme.text } } className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8">
                ...
                <div style={ { color: theme.text } } className="space-y-6">
                    ...
                    <div style={ { backgroundColor: theme.tertiary, color: theme.text } } className="text-lg font-semibold p-4 rounded-lg border border-yellow-200">
                        And to be a partner/associate with Halekard Private Limited (Healthkard), we would highly recommend Hospital/ Practitioner to check most important points (21-24 in Table of contents) in this terms.
                    </div>

                    {/* Age Restriction Warning */ }
                    <div style={ { backgroundColor: theme.danger, color: theme.text } } className="text-lg font-medium p-4 rounded-lg border border-red-200">
                        The Services are Intended for Doctors/ owner of the Hospital, who are at least 18 years old. Persons under the age of 18 are not permitted to partner or register for the Services.
                    </div>
...
export default withTheme(HospitalTC);